...
class Company {
  ...
  /** Find all companies.
   *
   * Optionally filter by name, minEmployees, and maxEmployees.
   *
   * Returns [{ handle, name, description, numEmployees, logoUrl }, ...]
   * */
  ...
  /** Delete given company from the database; returns undefined.
   *
