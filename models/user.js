...
class User {
   ...
   *   where applications is [{ jobId, title, companyHandle, companyName, state }, ...]
   *
  ...
  /**
   * Apply for a job: update the database, returns undefined.
   *
   * - username: username applying for the job
   * - jobId: job id
   */
